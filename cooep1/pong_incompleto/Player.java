...
public class Player {
	//posicao do player no eixo X
	private double cx;
	//posicao do player no eixo Y
	private double cy;
	//largura do player
	...
	//nome do player("Player 1" ou "Player 2")
	private String id;
	//limite vertical da area util da quadra
	...
	*/
	...
	public void moveUp(long delta){
		//incrementa a posicao do Y na forma velocidade * tempo + a posicao anterior
		double aux = this.cy - this.speed*delta;
		
		if(aux - this.height/2 >this.v_limit[0])
			this.cy = aux;
	...
	*/
	...
	public void moveDown(long delta){
		//incrementa a posicao do Y na forma posicao anterior - velocidade * tempo 
		double aux = this.cy + this.speed*delta;
		
		if(aux+this.height/2 <this.v_limit[1])
			this.cy = aux;
	}
